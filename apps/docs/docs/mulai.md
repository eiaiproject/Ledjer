...
Buka [ledjer.id](https://ledjer.id) lalu pilih **Daftar**.
...
| Kolom | Keterangan |
|-------|-----------|
| **Nama organisasi** | Nama usaha atau toko Anda |
| **Jenis bisnis** | `Perdagangan sederhana` (jual barang) atau `Jasa` (jual layanan) |
| **Tanggal mulai pembukuan** | Kapan Anda mulai mencatat. Transaksi sebelum tanggal ini ditolak. |
...
Lihat [FAQ](/faq) atau hubungi [support@ledjer.id](mailto:support@ledjer.id). Email dibalas dalam 1×24 jam di hari kerja.
