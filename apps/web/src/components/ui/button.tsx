...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  success: "bg-leaf-600 text-text-on-success hover:bg-leaf-700 active:bg-leaf-800 shadow-sm",
  ...
  return (
    <Component
      ...
      className={cn(
        ...
        size === "xs" && "min-h-[44px] h-7 px-2.5 text-xs gap-1 rounded-md",
        size === "icon" && "h-10 w-10 p-0 justify-center rounded-md min-h-[44px] min-w-[44px]",
