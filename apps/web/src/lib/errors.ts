const ERROR_MESSAGES: Record<string, string> = {
  ...
  account_name_taken: 'Nama akun sudah dipakai di buku ini.',
  ...
  items_required: 'Minimal satu produk harus diisi.',
  items_not_allowed: 'Item produk hanya untuk pembelian atau penjualan barang.',
  duplicate_product: 'Produk yang sama tidak boleh diisi dua kali.',
  product_required: 'Pilih produk.',
  product_not_found: 'Produk tidak ditemukan.',
  product_inactive: 'Produk tidak aktif. Pilih produk lain.',
  product_in_use: 'Produk sudah dipakai transaksi dan tidak dapat dinonaktifkan.',
  product_name_taken: 'Nama produk sudah dipakai di buku ini.',
  product_name_required: 'Nama produk harus diisi.',
  product_name_too_long: 'Nama produk maksimal 80 karakter.',
  product_unit_required: 'Satuan harus diisi.',
  invalid_price: 'Harga harus bilangan bulat rupiah tidak negatif.',
  invalid_unit_cost: 'Harga beli tidak valid.',
  invalid_unit_price: 'Harga jual tidak valid.',
  invalid_quantity: 'Jumlah tidak valid.',
  insufficient_stock: 'Stok produk tidak mencukupi.',
  inventory_account_missing: 'Akun Persediaan belum tersedia. Hubungi dukungan.',
  cogs_account_missing: 'Akun HPP belum tersedia. Hubungi dukungan.',
  amount_mismatch: 'Nominal tidak sesuai total harga jual produk.',
