          ...
          <>
            {cashBankEmpty && hasSearch ? (
              ...
              <EmptyState
                ...
                action={canManageAccounts ? <Button type="button" onClick={() => setAddModalOpen(true)}><Plus className="mr-2 h-4 w-4" aria-hidden="true" />Tambah Kas/Bank</Button> : undefined}
              />
            ) : (
              <div className="grid gap-4 sm:grid-cols-2">
