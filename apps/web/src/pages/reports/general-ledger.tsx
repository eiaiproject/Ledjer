...
export function GeneralLedgerPage() {
  ...
  // ponytail: extracted grouping logic from inline IIFE for cognitive complexity
                    ...
                    accountGroups.map((group) => (
                      <Fragment key={group.code}>
                        ...
                        {group.entries.map((entry) => (
                          <tr key={`${group.code}-${entry.journal_entry_id}`} className="border-b border-wood-50 hover:bg-cream-100/50">
