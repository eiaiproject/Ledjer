 ...
 *
 * Three users, each with their own book (1 user = 1 buku) and session. Book A
 * carries a full MVP chart of accounts and
...
export const FIXTURE_IDS = {
  users: {
    ownerA: "user-booka-owner-00001",
    ownerB: "user-bookb-owner-00001",
...
const SEED_USERS: SeedUser[] = [
  { id: FIXTURE_IDS.users.ownerA, email: "owner@booka.test", password_hash: "", full_name: "Owner A", business_name: "PT Buku A", status: "active", created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.users.ownerB, email: "owner@bookb.test", password_hash: "", full_name: "Owner B", business_name: "CV Buku B", status: "active", created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.users.ownerEmpty, email: "owner@empty.test", password_hash: "", full_name: "Owner Empty", business_name: "Buku Kosong", status: "active", created_at: NOW, updated_at: NOW },
];
...
const SEED_ACCOUNTS: SeedAccount[] = [
  { id: FIXTURE_IDS.accounts.cashA, user_id: FIXTURE_IDS.users.ownerA, code: "1110", name: "Kas", account_class: "asset", account_subtype: "cash", account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.bankA, user_id: FIXTURE_IDS.users.ownerA, code: "1120", name: "Bank", account_class: "asset", account_subtype: "bank", account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.inventoryA, user_id: FIXTURE_IDS.users.ownerA, code: "1130", name: "Persediaan", account_class: "asset", account_subtype: null, account_kind: "inventory", is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.cogsA, user_id: FIXTURE_IDS.users.ownerA, code: "6190", name: "Harga Pokok Penjualan", account_class: "expense", account_subtype: null, account_kind: "cogs", is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.equityA, user_id: FIXTURE_IDS.users.ownerA, code: "3110", name: "Modal Pemilik", account_class: "equity", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.drawA, user_id: FIXTURE_IDS.users.ownerA, code: "3120", name: "Pengambilan Pemilik", account_class: "equity", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.revenueA, user_id: FIXTURE_IDS.users.ownerA, code: "4110", name: "Pendapatan Usaha", account_class: "income", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.otherRevenueA, user_id: FIXTURE_IDS.users.ownerA, code: "4120", name: "Pendapatan Lain", account_class: "income", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.expenseSalaryA, user_id: FIXTURE_IDS.users.ownerA, code: "6110", name: "Beban Gaji & Upah", account_class: "expense", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.expenseRentA, user_id: FIXTURE_IDS.users.ownerA, code: "6120", name: "Beban Sewa", account_class: "expense", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.cashB, user_id: FIXTURE_IDS.users.ownerB, code: "1110", name: "Kas", account_class: "asset", account_subtype: "cash", account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.inventoryB, user_id: FIXTURE_IDS.users.ownerB, code: "1130", name: "Persediaan", account_class: "asset", account_subtype: null, account_kind: "inventory", is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.cogsB, user_id: FIXTURE_IDS.users.ownerB, code: "6190", name: "Harga Pokok Penjualan", account_class: "expense", account_subtype: null, account_kind: "cogs", is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.equityB, user_id: FIXTURE_IDS.users.ownerB, code: "3110", name: "Modal Pemilik", account_class: "equity", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.revenueB, user_id: FIXTURE_IDS.users.ownerB, code: "4110", name: "Pendapatan Usaha", account_class: "income", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.accounts.expenseB, user_id: FIXTURE_IDS.users.ownerB, code: "6110", name: "Beban Gaji & Upah", account_class: "expense", account_subtype: null, account_kind: null, is_system: 1, is_active: 1, created_at: NOW, updated_at: NOW },
];

// Produk di-seed tanpa stok awal; WAC/stok diuji melalui transaksi pembelian.
const SEED_PRODUCTS: SeedProduct[] = [
  { id: FIXTURE_IDS.products.kopiA, user_id: FIXTURE_IDS.users.ownerA, code: "PRD-0001", name: "Kopi Bubuk 250g", unit: "bungkus", selling_price_idr: 50000, current_stock_milli: 0, average_cost_minor: 0, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.products.gulaA, user_id: FIXTURE_IDS.users.ownerA, code: "PRD-0002", name: "Gula Pasir 1kg", unit: "kg", selling_price_idr: 18000, current_stock_milli: 0, average_cost_minor: 0, is_active: 1, created_at: NOW, updated_at: NOW },
  { id: FIXTURE_IDS.products.kopiB, user_id: FIXTURE_IDS.users.ownerB, code: "PRD-0001", name: "Kopi Bubuk 250g", unit: "bungkus", selling_price_idr: 55000, current_stock_milli: 0, average_cost_minor: 0, is_active: 1, created_at: NOW, updated_at: NOW },
];
...
const SEED_TRANSACTIONS: SeedTransaction[] = [
  ...
  {
    id: FIXTURE_IDS.transactions.cashInA, user_id: FIXTURE_IDS.users.ownerA,
  ...
  {
    id: FIXTURE_IDS.transactions.cashOutA, user_id: FIXTURE_IDS.users.ownerA,
  ...
  {
    id: FIXTURE_IDS.transactions.transferA, user_id: FIXTURE_IDS.users.ownerA,
  ...
  {
    id: FIXTURE_IDS.transactions.voidedOutA, user_id: FIXTURE_IDS.users.ownerA,
  ...
  {
    id: FIXTURE_IDS.transactions.cashInB, user_id: FIXTURE_IDS.users.ownerB,
...
const SEED_JOURNAL_LINES: SeedJournalLine[] = SEED_TRANSACTIONS.flatMap((t) => {
  ...
  const creditAccountId = t.transaction_type === "cash_in" || t.transaction_type === "owner_deposit"
    ...
    : t.cash_account_id;
  return [
    { id: `jl-${t.id}-d`, user_id: t.user_id, journal_entry_id: entry.id, account_id: debitAccountId, debit_idr: t.amount_idr, credit_idr: 0, created_at: NOW },
    { id: `jl-${t.id}-c`, user_id: t.user_id, journal_entry_id: entry.id, account_id: creditAccountId, debit_idr: 0, credit_idr: t.amount_idr, created_at: NOW },
  ];
});
...
function allTransactions(userId?: string): SeedTransaction[] {
  return userId ? transactions.filter((t) => t.user_id === userId) : transactions;
}

function allAccounts(userId?: string): SeedAccount[] {
  return userId ? accounts.filter((a) => a.user_id === userId) : accounts;
}

function accountById(userId: string, accountId: string): SeedAccount | undefined {
  return allAccounts(userId).find((a) => a.id === accountId);
}

function allProducts(userId?: string): SeedProduct[] {
  return userId ? products.filter((p) => p.user_id === userId) : products;
}

function productById(userId: string, productId: string): SeedProduct | undefined {
  return allProducts(userId).find((p) => p.id === productId);
}
 ...
 */
function selectProducts(sql: string, values: unknown[], userId: string): SeedProduct[] {
  const s = sql.toLowerCase();
  let result = allProducts(userId);
  let idx = 1;
...
function userTransactions(userId: string): SeedTransaction[] {
  return allTransactions(userId);
}

function toTransactionReadback(t: SeedTransaction, userId: string): Record<string, unknown> {
  const cash = accountById(userId, t.cash_account_id);
  const counter = accountById(userId, t.counter_account_id);
  return {
    id: t.id,
    user_id: t.user_id,
...
function handleFirst(sql: string, values: unknown[]): unknown { // NOSONAR:S3776 - fake-D1 dispatcher mirrors real query shapes
  ...
  if (s.includes("FROM accounts")) {
    // Name-taken lookups: SELECT id FROM accounts WHERE user_id = ? AND name = ? [AND id != ?]
    if (s.includes("name = ?")) {
      const userId = values[0] as string;
      const name = values[1] as string;
      const excludeId = s.includes("id != ?") ? (values[2] as string) : undefined;
      const account = allAccounts(userId).find((a) => a.name === name && a.id !== excludeId);
      return account ? { id: account.id } : null;
    }
    // nextCashBankCode collision check: SELECT id FROM accounts WHERE user_id = ? AND code = ?
    if (s.includes("code = ?") && !s.includes("account_kind")) {
      const userId = values[0] as string;
      const code = values[1] as string;
      const account = allAccounts(userId).find((a) => a.code === code);
      return account ? { id: account.id } : null;
    }
    ...
    if (s.includes("MAX(CAST(code AS INTEGER))")) {
      ...
      const maxCode = allAccounts(userId)
    ...
    // getAccountByKind: ... WHERE user_id = ? AND account_kind = ? AND is_active = 1
    if (s.includes("account_kind = ?")) {
      const userId = values[0] as string;
      const kind = values[1] as "inventory" | "cogs";
      const account = allAccounts(userId).find(
        (a) => a.account_kind === kind && a.is_active === 1,
      );
      return account ? { ...account } : null;
    }
    // getAccount: SELECT ... FROM accounts WHERE id = ? AND user_id = ?
    if (s.includes("WHERE id = ?") && s.includes("user_id = ?")) {
      const account = allAccounts().find(
        (a) => a.id === values[0] && a.user_id === values[1],
      );
      return account ? { ...account } : null;
    }
    return null;
  ...
  if (s.includes("FROM products")) {
    ...
    if (s.includes("products:count")) {
      const userId = values[0] as string;
      return { total: selectProducts(s, values, userId).length };
    }
    // Name-taken lookups
    if (s.includes("name = ?")) {
      const userId = values[0] as string;
      const name = values[1] as string;
      const excludeId = s.includes("id != ?") ? (values[2] as string) : undefined;
      const product = allProducts(userId).find((p) => p.name === name && p.id !== excludeId);
    ...
    if (s.includes("SUBSTR(code, 5)")) {
      const userId = values[0] as string;
      const maxSeq = allProducts(userId)
        .filter((p) => p.code.startsWith("PRD-"))
        .reduce((max, p) => Math.max(max, Number(p.code.slice(4)) || 0), 0);
      return { max_seq: maxSeq };
    }
    // Code collision check: SELECT id FROM products WHERE user_id = ? AND code = ?
    if (s.includes("code = ?")) {
      const userId = values[0] as string;
      const code = values[1] as string;
      const product = allProducts(userId).find((p) => p.code === code);
      return product ? { id: product.id } : null;
    }
    // getProduct: SELECT ... WHERE id = ? AND user_id = ?
    if (s.includes("WHERE id = ?") && s.includes("user_id = ?")) {
      const product = allProducts().find(
        (p) => p.id === values[0] && p.user_id === values[1],
      );
  ...
  if (s.includes("COUNT(*)") && s.includes("FROM stock_movements sm")) {
    ...
    const count = stockMovements.filter(
      (m) => m.user_id === userId && m.product_id === productId &&
  ...
  if (s.includes("COUNT(*)") && s.includes("FROM transactions") && s.includes("cash_account_id = ?")) {
    ...
    return {
      c: userTransactions(userId).filter(
  ...
  if (s.includes("COUNT(*)") && s.includes("FROM transactions")) {
    const userId = values[0] as string;
    const result = applyTransactionFilters(userTransactions(userId), s, values, "");
  ...
  if (s.includes("FROM transactions")) {
    ...
    if (s.includes("t.idempotency_key = ?") || s.includes("idempotency_key = ?")) {
      ...
      const txn = transactions.find(
        (t) => t.user_id === userId && t.idempotency_key === key,
      );
    ...
    if (s.includes("WHERE id = ?") && s.includes("user_id = ?") && !s.includes("LEFT JOIN")) {
      const txn = transactions.find(
        (t) => t.id === values[0] && t.user_id === values[1],
      );
    ...
    if (s.includes("LEFT JOIN") && s.includes("t.id = ?")) {
      ...
      return txn ? toTransactionReadback(txn, txn.user_id) : null;
    }
    return null;
  }
  ...
  if (s.includes("FROM journal_entries")) {
    ...
    const entry = journalEntries.find(
      (e) => e.transaction_id === txnId && e.user_id === userId,
    );
...
function handleAll(sql: string, values: unknown[]): unknown[] { // NOSONAR:S3776 - fake-D1 dispatcher mirrors real query shapes
  ...
  if (s.includes("FROM transactions t") && s.includes("LEFT JOIN accounts")) {
    const userId = values[0] as string;
    const result = applyTransactionFilters(userTransactions(userId), s, values, "t.");
    return result.map((t) => toTransactionReadback(t, userId));
  }

  // Account list (plain SELECT ... FROM accounts WHERE user_id = ?)
  if (s.includes("FROM accounts") && !s.includes("FROM accounts a") && !s.includes("ORDER BY")) {
    const userId = values[0] as string;
    return allAccounts(userId).map((a) => ({ ...a }));
  }

  // Account list
  if (s.includes("FROM accounts a") || (s.includes("FROM accounts") && s.includes("ORDER BY a.code"))) {
    const userId = values[0] as string;
    let result = allAccounts(userId);
  ...
  if (s.includes("FROM journal_lines jl") && s.includes("GROUP BY jl.account_id")) {
    const userId = values[0] as string;
    const totals = journalTotalsByAccount(userId, {});
  ...
  if (s.includes("FROM journal_lines jl") && s.includes("GROUP BY a.id")) {
    ...
    const totals = journalTotalsByAccount(userId, { toDate, fromDate });
    return [...totals.entries()].map(([account_id, { debit, credit }]) => {
      const account = allAccounts(userId).find((a) => a.id === account_id);
      return {
        id: account_id,
        code: account?.code ?? "",
        name: account?.name ?? "",
  ...
  if (s.includes("ledger_base") && s.includes("running_balance_idr")) {
    ...
    const rows: GlLine[] = [];
    for (const line of journalLines.filter((l) => l.user_id === userId)) {
      ...
      const account = allAccounts(userId).find((a) => a.id === line.account_id);
      if (!account) continue;
      rows.push({
    ...
    const accountIds = [...byAccount.keys()].sort((x, y) => {
      const ax = allAccounts(userId).find((a) => a.id === x);
      const ay = allAccounts(userId).find((a) => a.id === y);
  ...
  if (s.includes("FROM products") && !s.includes("JOIN")) {
    ...
    return selectProducts(s, values, userId).map((p) => ({ ...p }));
  }
  ...
  if (s.includes("FROM stock_movements sm") && s.includes("JOIN products p") && s.includes("sm.transaction_id = ?")) {
    ...
    return stockMovements
      .filter((m) => m.user_id === userId && m.transaction_id === transactionId)
      .map((m) => {
        const product = productById(userId, m.product_id);
        return {
  ...
  // Void: SELECT product_id FROM stock_movements WHERE user_id = ? AND transaction_id = ?
  ...
  if (s.includes("GROUP BY transaction_type") && s.includes("SUM(amount_idr)")) {
    ...
    for (const t of transactions.filter(
      (tx) => tx.user_id === userId && tx.status === "posted" &&
...
function handleRun(sql: string, values: unknown[]): D1Result { // NOSONAR:S3776 - fake-D1 dispatcher mirrors real query shapes
  ...
  if (s.includes("INSERT INTO users")) {
    // values: id, email, password_hash, full_name, business_name, created_at, updated_at
    insertedUsers.push({
      id: values[0] as string,
      email: values[1] as string,
      password_hash: values[2] as string,
      full_name: values[3] as string,
      business_name: values[4] as string,
      status: "active",
  ...
  if (s.includes("UPDATE users SET")) {
    const user = findUserByIdOrEmail(values.at(-1) as string);
    if (user) {
      if (s.includes("business_name = ?")) user.business_name = values[0] as string;
      if (s.includes("password_hash = ?")) user.password_hash = values[0] as string;
      user.updated_at = Number(values.at(-2));
    }
  }
  ...
  if (s.includes("INSERT INTO sessions")) {
    // values: (id, user_id, token_hash, ip, ua, expires_at, last_used_at, created_at)
    sessions.push({
      id: values[0] as string,
      user_id: values[1] as string,
      token_hash: values[2] as string,
      expires_at: Number(values[5]),
      last_used_at: Number(values[6]),
  ...
  if (s.includes("INSERT INTO accounts")) {
    if (values.length === 10) {
      ...
      // values: id, user_id, code, name, class, subtype, kind, is_system, created, updated
      accounts.push({
        id: values[0] as string,
        user_id: values[1] as string,
      ...
      // values: id, user_id, code, name, class, created, updated
      accounts.push({
        id: values[0] as string,
        user_id: values[1] as string,
        code: values[2] as string,
      ...
      // values: id, user_id, code, name, subtype, created, updated
      accounts.push({
        id: values[0] as string,
        user_id: values[1] as string,
        code: values[2] as string,
  ...
  if (s.includes("INSERT INTO products")) {
    // values: id, user_id, code, name, unit, selling_price_idr, created, updated
    products.push({
      id: values[0] as string,
      user_id: values[1] as string,
      code: values[2] as string,
  ...
  if (s.includes("UPDATE products SET")) {
    ...
    //   SET current_stock_milli=?, average_cost_minor=?, updated_at=? WHERE id=? AND user_id=? AND current_stock_milli=? AND average_cost_minor=?
    if (s.includes("AND current_stock_milli = ?")) {
      ...
      //   SET current_stock_milli=?, average_cost_minor=?, updated_at=? WHERE id=? AND user_id=?
      const product = productById(values[4] as string, values[3] as string);
      if (product) {
        product.current_stock_milli = Number(values[0]);
        product.average_cost_minor = Number(values[1]);
      ...
      // Patch shape: ... updated_at=? WHERE id=? AND user_id=?
  ...
  if (s.includes("INSERT INTO stock_movements")) {
    // values: id, user_id, transaction_id, product_id, quantity_milli, unit_cost_minor, cost_total_idr, created_at
    stockMovements.push({
      id: values[0] as string,
      user_id: values[1] as string,
  ...
  if (s.includes("INSERT INTO transactions")) {
    transactions.push({
      ...
      // values[12] is idempotency_payload_hash (appended last so the
      // positions before it stay stable).
      idempotency_payload_hash: (values[12] as string | undefined) ?? null,
