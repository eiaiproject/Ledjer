...
|---------|----------|-------|
| Site URL | Dashboard → Auth → Settings | `https://app.ledjer.id` |
...
| Domain | Purpose | DNS |
|--------|---------|-----|
| `app.ledjer.id` | Frontend hosting | CNAME to hosting platform |
...
1. [ ] Open `https://app.ledjer.id` — landing page loads.
