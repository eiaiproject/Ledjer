...
const accountLines = accounts.map(a => {
  ...
  (id, organization_id, code, name, account_class, account_subtype, account_kind, is_system, is_active, created_at, updated_at)
VALUES ('${id}', '${orgId}', '${a.code}', '${a.name}', '${a.accountClass}', ${subtype}, ${kind}, 1, 1, ${now}, ${now});`;
}).join("\n");
