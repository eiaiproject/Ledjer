-- Migration: Add validations to post_transaction (T2.1, T2.2, T2.3, T2.7)
-- Date: 2026-07-19
-- Purpose:
...
--   T2.7: Tighten simple_adjustment validation (different accounts required)
--   T2.14: Fix v_impact direction to use account's normal_balance
--
-- Changes:
--   - CREATE OR REPLACE post_transaction with additional validations
--
